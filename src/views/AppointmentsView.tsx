                    ...
                    <>
                      {app.type === 'telehealth' ? (
                        <motion.button 
                          ...
                          whileTap={{ scale: 0.98 }}
                          onClick={() => onJoinTelehealth?.(app)}
                          className="flex-1 py-4.5 bg-ruru-teal text-white rounded-[1.5rem] text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-3 shadow-xl shadow-ruru-teal/20 transition-all"
                        >
                          <Video size={18} />
                          Join Telehealth Vault
                        </motion.button>
                      ) : (
                        <motion.button 
                          whileHover={{ scale: 1.02 }}
