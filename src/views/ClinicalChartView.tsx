    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          <div className="bg-white rounded-3xl p-6 border border-slate-200/50 shadow-xs">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <div className="border border-slate-100 p-4 rounded-2xl bg-slate-50/50 flex flex-col gap-1.5">
                <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest flex items-center gap-1.5">
                  <Heart size={10} className="text-rose-500" /> Vitals
                </span>
              ...
              <div className="border border-slate-100 p-4 rounded-2xl bg-slate-50/50 flex flex-col gap-1.5">
                <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest flex items-center gap-1.5">
                  <Droplet size={10} className="text-blue-500" /> Hydration
                </span>
                <div className="flex items-baseline gap-2 mt-1">
                  <span className="text-xl font-black text-slate-800 font-mono">94</span>
                  <span className="text-[10px] text-blue-600 font-bold uppercase">%</span>
                </div>
              </div>

              <div className="border border-slate-100 p-4 rounded-2xl bg-slate-50/50 flex flex-col gap-1.5 col-span-2 md:col-span-1">
                <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest flex items-center gap-1.5">
                  <Activity size={10} className="text-emerald-500" /> Temp
                </span>
                <div className="flex items-baseline gap-2 mt-1">
                  <span className="text-xl font-black text-slate-800 font-mono">101.5</span>
