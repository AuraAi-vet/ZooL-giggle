    ...
    <div className="p-6 md:p-8 min-h-screen bg-transparent relative">
      ...
      <header className="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-8 relative z-10 w-full bg-white/70 backdrop-blur-xl p-8 rounded-[2.5rem] shadow-[0_8px_30px_-4px_rgba(0,0,0,0.03)] border border-slate-200/60">
        <div className="flex items-center gap-6">
           <HealthHaloAvatar 
             imageUrl={primaryPet?.imageUrl || "https://images.unsplash.com/photo-1543466835-00a7907e9de1?q=80&w=200&auto=format&fit=crop"} 
      ...
      <motion.div variants={containerVars} initial="hidden" animate="show" className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8">
        ...
        <motion.div variants={itemVars} className="lg:col-span-8 flex flex-col gap-6 md:gap-8">
        ...
        <motion.div variants={itemVars} className="lg:col-span-4 flex flex-col gap-6 md:gap-8">
