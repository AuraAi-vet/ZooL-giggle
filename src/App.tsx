...
function AppContent() {
      ...
      <div className="min-h-[100dvh] flex flex-col items-center justify-center max-w-5xl mx-auto bg-[#0B192C] sm:h-auto sm:min-h-[850px] sm:my-8 sm:rounded-[2.5rem] sm:border-[8px] sm:border-[#0B192C] relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center gap-12">
           ...
           <div className="flex flex-col items-center gap-5 mt-4">
               ...
               <p className="text-[#E5D5C5] font-brand tracking-widest uppercase text-[10px] font-black animate-pulse">Initializing Ecosystem</p>
           </div>
        </div>
      </div>
    );
  ...
  return (
    <div className={cn(
      "min-h-[100dvh] flex flex-col max-w-5xl mx-auto bg-gradient-to-b from-white to-ruru-teal/5 sm:h-auto sm:min-h-[850px] sm:my-8 sm:rounded-[2.5rem] sm:border-[8px] sm:border-[#0B192C] sm:shadow-2xl relative overflow-hidden",
      darkMode && "dark"
    )}>
      {/* Setup & Tours */}
      ...
      >
        ...
        >
          <ZooLLogo size="md" className="drop-shadow-sm" />
          <div className="hidden sm:flex bg-gradient-to-r from-amber-500 to-orange-500 text-white px-3 py-1 rounded-[1rem] text-[10px] font-black uppercase tracking-widest flex-row items-center gap-1.5 shadow-md shadow-orange-500/20 whitespace-nowrap">
            <span role="img" aria-label="gift">🎁</span> ZooL Trial Mode Active
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden sm:flex items-center gap-1.5 mr-6">
              <div className={cn(
                ...
                syncStatus === 'synced' ? "bg-ruru-teal" : 
                syncStatus === 'syncing' ? "bg-amber-500" : "bg-red-500"
              )} />
              <p className="text-[10px] font-bold uppercase tracking-widest text-ruru-navy/60">
