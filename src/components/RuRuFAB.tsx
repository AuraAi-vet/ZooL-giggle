    ...
    >
      ...
      >
        ...
        <div className="relative">
          <RuRuIcon size={64} role={role} status={showOptions ? 'idle' : 'listening'} className="shadow-[0_20px_50px_rgba(52,181,199,0.3)] shadow-ruru-teal/40 group-hover:shadow-[0_20px_50px_rgba(161,80,160,0.4)] transition-shadow duration-700 rounded-full bg-ruru-navy-light pt-1.5" />
