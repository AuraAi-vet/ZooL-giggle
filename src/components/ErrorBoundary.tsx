...
import { logErrorToBatch } from '../services/errorLoggingService';
...
export class ErrorBoundary extends Component<Props, State> {
  ...
  public componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    ...
    // Log exception directly to batcher as soon as it's caught
    logErrorToBatch({
  ...
  public handleRetry = async () => {
    if (this.state.error) {
      ...
      console.log("Telemetry: Error boundary retry logged to batcher.");
    }
