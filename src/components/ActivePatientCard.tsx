...
// ⚡ Bolt: Wrapped in React.memo to prevent unnecessary re-renders when the parent dashboard updates
// Expected Impact: Reduces re-renders of list items in dashboard views
const ActivePatientCard = React.memo(function ActivePatientCard({
  petName,
  speciesBreed,
  avatarUrl,
  healthStatus,
